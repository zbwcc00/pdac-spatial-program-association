...
def load_locked_module():
    module = importlib.util.module_from_spec(importlib.util.spec_from_loader("locked_v2_for_v4", loader=None))
    ...
    if count != 1:
        raise RuntimeError("Could not set locked v2 project path")
