# Supplementary methods and data dictionary (v7; release v1.0.2 prepared for publication)
...
At the time this file was prepared, the latest published archive was Zenodo v1.0.1 (https://doi.org/10.5281/zenodo.21953739); its stable concept DOI is https://doi.org/10.5281/zenodo.21951887. Release v1.0.2 must be published to GitHub and archived by Zenodo before this document or the manuscript claims it as public. The prepared v1.0.2 package contains the submission manuscript, this supplementary methods/data dictionary, `supplementary_pack_manifest_v7.json`, public reproducibility documentation, and `release_manifest.json`; raw GEO archives are not redistributed. The release manifest records SHA-256 values for public files.
